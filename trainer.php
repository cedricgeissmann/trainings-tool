...
<script type="text/javascript" src="transformation/trainerTransforms/outterTrainingPlanTransform.js"></script>
<script type="text/javascript" src="transformation/trainerTransforms/innerTrainingPlanTransform.js"></script>
<script type="text/javascript" src="transformation/trainerTransforms/trainingPlanHeaderTransform.js"></script>
<script type="text/javascript" src="transformation/trainerTransforms/trainerSelectionTransform.js"></script>
...
<script type="text/javascript" src="javascript/trainer.js"></script>
...
<div class="container">
    <div class="row">
		<div class="btn-group">
			<button type="button" class="btn btn-default" id="showListButton">
				Liste
			</button>
			<button type="button" class="btn btn-default" id="showCalendarButton">
				Kalender
			</button>
		</div>
        <div id="content">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		<button type="submit" class="btn btn-danger" data-dismiss="modal" onclick="deleteExercise()" id="deleteExerciseButton">Löschen</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Abbrechen</button>
        <button type="submit" class="btn btn-primary" data-dismiss="modal" onclick="createNewExercise()" id="createExerciseButton">Erstellen</button>
      </div>
    </div>
  </div>
</div>
